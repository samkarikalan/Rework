...
function createPlayerCard(player, index) {
  ...
  card.innerHTML = `
    ...
    <div class="pec-col pec-delete">
      <button class="pec-delete-btn circle-btn" onclick="deletePlayer(${index})" style="background:rgba(230,55,87,0.15);color:#e63757;font-size:1.1rem;font-weight:700;width:28px;height:28px;flex-shrink:0;">−</button>
    </div>
  `;
  return card;
}
